// src/features/family-tree/api/buildPersonContext.ts
...
import type { FamilyGraphPerson, FamilyGraphData, FamilyGraphFamily } from "../../types/graph";
