  ...
  return (
    <div className="min-h-screen bg-[color:var(--bg)] text-[color:var(--text)]">
      <main className="c-container pb-24 pt-3">
        ...
        <section className="sticky top-0 z-30 -mx-1 mb-4 mt-3 border-b border-slate-200/80 bg-[color:var(--bg)]/95 px-1 pb-3 pt-1 backdrop-blur">
          <div className="rounded-[26px] bg-[linear-gradient(135deg,#0f172a_0%,#1e293b_45%,#312e81_100%)] p-4 text-white shadow-[0_18px_40px_rgba(15,23,42,0.20)]">
            ...
            <div className="mt-3 max-w-[42rem] text-sm font-bold leading-6 text-white/90">
              Tu peux partir d’indices familiaux, puis vérifier toi-même le bon
              profil avant de naviguer dans l’arbre.
            </div>
          </div>
        </section>
