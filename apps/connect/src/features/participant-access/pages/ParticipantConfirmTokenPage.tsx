...
import { confirmParticipantRecovery } from "../api/confirmParticipantRecovery";
...
import { sendParticipantConnectionViaToken } from "../api/sendParticipantConnectionViaToken";

export function ParticipantConfirmTokenPage() {
