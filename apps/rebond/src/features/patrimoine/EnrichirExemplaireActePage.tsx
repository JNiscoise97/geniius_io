...
import {
  Loader2, AlertCircle, Globe, Building2, Monitor, BookOpen,
  ...
  if (error || !draft) return (
    <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
      <div className='text-center'>
        ...
        <button onClick={() => navigate('/patrimoine-documentaire')} className='text-sm text-gray-500 hover:text-gray-700'>← Retour</button>
      </div>
    </div>
  )
