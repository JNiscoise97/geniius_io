...
import type { ActeursParActe } from "@/features/individu/analyse-famille/AnalyseFamileParents";
...
export function getAnalysePatronyme(mentions: any[], _individu: any): string {
  const totalMentions = mentions.length;
