...
import { AtelierExemplairesPage as AtelierExemplairesContent } from '../features/atelier/AtelierExemplairesPage'

export default function AtelierExemplairesPage() {
  ...
  return <AtelierExemplairesContent />
}
