...
import { EnrichirExemplaireActePage as EnrichirExemplaireActeContent } from '../features/patrimoine/EnrichirExemplaireActePage'

export default function EnrichirExemplaireActePage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder à cet exemplaire
        </h1>
        <Link
          to="/login"
  ...
  return <EnrichirExemplaireActeContent />
}
