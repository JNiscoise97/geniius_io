...
import { Loader2, LogIn, Users2 } from 'lucide-react'
import { useSession } from '../lib/supabase/useSession'
import { EntitesHubPage as EntitesHubContent } from '../features/entites/EntitesHubPage'

export default function EntitesHubPage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder aux entités
        </h1>
        <Link
          to="/login"
