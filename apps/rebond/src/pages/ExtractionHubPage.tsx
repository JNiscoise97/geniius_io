...
import { ExtractionHubPage as ExtractionHubContent } from '../features/extraction/ExtractionHubPage'

export default function ExtractionHubPage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder à l'extraction
        </h1>
        <Link
          to="/login"
