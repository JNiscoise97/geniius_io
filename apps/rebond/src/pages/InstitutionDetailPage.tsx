...
import { InstitutionDetailPage as InstitutionDetailContent } from '../features/patrimoine/InstitutionDetailPage'
...
export default function InstitutionDetailPage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder à cette institution
        </h1>
        <Link
          to="/login"
  ...
  return <InstitutionDetailContent />
}
