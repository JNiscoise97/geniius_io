...
import { PatrimoineDocumentairePage as PatrimoineDocumentaireContent } from '../features/patrimoine/PatrimoineDocumentairePage'

export default function PatrimoineDocumentairePage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder au patrimoine documentaire
        </h1>
        <Link
          to="/login"
  ...
  return <PatrimoineDocumentaireContent />
}
