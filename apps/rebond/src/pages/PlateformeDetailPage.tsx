...
import { PlateformeDetailPage as PlateformeDetailContent } from '../features/patrimoine/PlateformeDetailPage'

export default function PlateformeDetailPage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder à cette plateforme
        </h1>
        <Link
          to="/login"
  ...
  return <PlateformeDetailContent />
}
