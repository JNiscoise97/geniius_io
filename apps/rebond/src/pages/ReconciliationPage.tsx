...
import { Loader2, LogIn, GitMerge } from 'lucide-react'
import { useSession } from '../lib/supabase/useSession'
import { ReconciliationPage as ReconciliationContent } from '../features/reconciliation/ReconciliationPage'
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder à la réconciliation
        </h1>
        <Link
          to="/login"
