...
import { ReferenceWizardPage as ReferenceWizardContent } from '../features/patrimoine/ReferenceWizardPage'

export default function ReferenceWizardPage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour référencer un document
        </h1>
        <Link
          to="/login"
