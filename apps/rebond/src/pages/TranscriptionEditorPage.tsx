...
import { TranscriptionEditorPage as TranscriptionEditorContent } from '../features/atelier/TranscriptionEditorPage'
...
export default function TranscriptionEditorPage() {
    ...
    return (
      <CenteredState>
        ...
        <h1 className="mt-4 text-xl font-black text-slate-950">
          Connectez-vous pour accéder à la transcription
        </h1>
        <Link
          to="/login"
  ...
  return <TranscriptionEditorContent />
}
