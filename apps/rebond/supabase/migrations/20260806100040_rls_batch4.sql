-- RLS pour les 4 tables de ce lot, même policy ouverte que les lots précédents.
...
begin
  foreach t in array array[
    'ref_role_document',
    'ref_type_unite',
    'ref_acces_numeriques',
    'ref_series_documentaires'
  ]
  loop
...
grant execute on function rebond.get_bureau_stats() to anon, authenticated, service_role;
