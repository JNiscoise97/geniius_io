-- Met à jour v_sources et v_exemplaires_pick pour pointer ref_natures/
-- ref_supports vers rebond (migrées dans ce lot) au lieu du cross-schema
-- vers public. Dernière trace de cross-schema de toute la migration levée.
-- CREATE OR REPLACE VIEW : listes de colonnes de sortie inchangées, sûr.
