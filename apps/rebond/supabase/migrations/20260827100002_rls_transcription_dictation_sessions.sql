-- RLS pour rebond.transcription_dictation_sessions — même policy ouverte
-- que le reste du schéma rebond (choix assumé, cf. les autres migrations RLS
-- de ce dossier, pas une décision de sécurité prise ici).
...
begin
  foreach t in array array[
    'transcription_dictation_sessions'
  ]
  loop
