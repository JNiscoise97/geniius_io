...
export function AncestorNode({
  ...
  return (
    <div className={`rounded-2xl border p-3 shadow-md ${toneClasses[tone]} ${className}`}>
      <p className={empty ? 'text-center text-sm font-semibold opacity-70' : 'text-sm font-black'}>
        {title}
      </p>
